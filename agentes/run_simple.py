...
def main():
    ...
    try:
        ...
        if pedestrian is not None:
            ...
            imu_pedestre = IMU(f"pedestre", world, 0, 0, 0, 0, tick_time, pedestrian)
            sensores_pedestres[pedestrian]['imu'] = imu_pedestre

            position_sensor_pedestre = PositionModule(f"pedestre", pedestrian, tick_time)
            sensores_pedestres[pedestrian]['position'] = position_sensor_pedestre


            print(f"Pedestre spawnado com sucesso!")
